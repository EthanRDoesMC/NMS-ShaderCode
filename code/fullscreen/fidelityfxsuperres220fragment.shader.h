...
#if defined ( D_PLATFORM_METAL ) || ( defined ( D_PLATFORM_SWITCH ) && ( !defined( D_FSR2_QUAD ) && !defined( D_FSR2_ACCUMULATE_PASS_FRAGMENT ) ) )
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_stability_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_stability_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_RECONSTRUCT_PREVIOUS_DEPTH_PASS )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_reconstruct_previous_depth_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_reconstruct_previous_depth_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_DEPTH_CLIP_PASS_FRAGMENT )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_depth_clip_pass_frag.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_depth_clip_pass_frag.hlsl"
#endif
#endif

#if defined( D_FSR2_DEPTH_CLIP_PASS_COMPUTE )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_depth_clip_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_depth_clip_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_LOCK_PASS )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_lock_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_lock_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_ACCUMULATE_PASS_FRAGMENT )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_accumulate_pass_frag.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_accumulate_pass_frag.hlsl"
#endif
#endif

#if defined( D_FSR2_ACCUMULATE_PASS_COMPUTE )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_accumulate_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_accumulate_pass.hlsl"
#endif
#endif
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_rcas_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_rcas_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_QUAD )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_quad_pass_vert.glsl"
#else
#include "Fullscreen/FidelityFX/FSR220/ffx_fsr2_quad_pass_vert.hlsl"
#endif
#endif
