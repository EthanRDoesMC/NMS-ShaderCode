...
//#define uint16BitsToHalf intBitsToFloat	  
//#define halfBitsToUint16 floatBitsToUint
//#define uint16BitsToHalf(_X) intBitsToFloat(_X)
//#define halfBitsToUint16(_X) asuint(_X)
...
#define FFX_FSR2_CUSTOM_OPTION_SPLIT_COLOUR_LUMA_BUFFERS        1
#define FFX_FSR2_CUSTOM_OPTION_SPLIT_HISTORY_STABILITY_BUFFERS  0
...
#define FFX_FSR2_CUSTOM_OPTION_MITCHELL_NETRAVALI_UPSAMPLING    1
#define FFX_FSR2_CUSTOM_OPTION_USE_UPSAMPLE_WEIGHTS_LUT         0
...
#define FFX_FSR2_CUSTOM_OPTION_MITCHELL_NETRAVALI_UPSAMPLING    0
#define FFX_FSR2_CUSTOM_OPTION_USE_UPSAMPLE_WEIGHTS_LUT         0
#define FFX_FSR2_CUSTOM_OPTION_LOCKS_LUMA_BIAS                  1
#define FFX_FSR2_CUSTOM_OPTION_UV_SPACE_MOTION_VECTORS          1
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_prepare_input_color_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_prepare_input_color_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_STABILITY_PASS_FRAGMENT )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_stability_pass_frag.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_stability_pass_frag.glsl"
#endif
#endif
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_stability_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_stability_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_RECONSTRUCT_PREVIOUS_DEPTH_PASS )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_reconstruct_previous_depth_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_reconstruct_previous_depth_pass.hlsl"
#endif
#endif

/*#if defined( D_FSR2_DEPTH_CLIP_PASS_FRAGMENT )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_depth_clip_pass_frag.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_depth_clip_pass_frag.hlsl"
#endif
#endif*/

#if defined( D_FSR2_DEPTH_CLIP_PASS_COMPUTE )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_depth_clip_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_depth_clip_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_LOCK_PASS )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_lock_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_lock_pass.hlsl"
#endif
#endif

#if defined( D_FSR2_MOMENTS_PASS )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/ffx_fsr2_moments_pass.glsl"
#else
#endif
#endif

#if defined( D_FSR2_PRE_UPSAMPLE_PASS_FRAGMENT )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/ffx_fsr2_pre_upsample_pass_frag.glsl"
#else
#endif
#endif

#if defined( D_FSR2_PRE_UPSAMPLE_PASS_COMPUTE )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/ffx_fsr2_pre_upsample_pass.glsl"
#else
#endif
#endif
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_accumulate_pass_frag.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_accumulate_pass_frag.hlsl"
#endif
#endif

#if defined( D_FSR2_ACCUMULATE_PASS_COMPUTE )
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_accumulate_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_accumulate_pass.hlsl"
#endif
#endif
...
#if defined( FFX_GLSL )
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_rcas_pass.glsl"
#else
#include "Fullscreen/FidelityFX/FSR212/ffx_fsr2_rcas_pass.hlsl"
#endif
#endif
