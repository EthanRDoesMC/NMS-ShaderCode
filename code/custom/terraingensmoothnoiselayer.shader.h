...
COMPUTE_MAIN_UNIF( 64, 1, 1, cTkGenerateSmoothNoiseLayer3DComputeUniforms )
{
    ...
    //output result of smooth noise function
    GETBUFF(mafNoise)[idx] = SmoothNoise(lPosition, lUniforms.mSeedOffset, lUniforms.mfFeatureScale, lUniforms.miOctaves);
}
